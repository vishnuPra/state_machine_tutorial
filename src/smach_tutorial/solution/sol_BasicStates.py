...
def main():
    ...
    introspection_server = qt_smach_viewer.introspection.IntrospectionServer( Wait_sm)
...
def main2():
    ...
    introspection_server = qt_smach_viewer.introspection.IntrospectionServer(SimpleSM)
    introspection_server.start()
    rospy.sleep(3.0)
